...
local Window = Fluent:CreateWindow({
    Title = "Nara Hub " .. Fluent.Version,
    SubTitle = "by Norataisen",
    TabWidth = 160,
...
if game.CoreGui:FindFirstChild("NaraHubOpenClose") then
    game.CoreGui:FindFirstChild("NaraHubOpenClose"):Destroy()
end
...
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "NaraHubOpenClose"
...
spawn(
    function()
        ...
        wait(1)
        require(game.ReplicatedStorage.Notification).new("<Color=Red>Nara Hub<Color=/>"):Display()
        wait(2)
        require(game.ReplicatedStorage.Notification).new("<Color=Red>https://discord.gg/wMAAcxjFww<Color=/>"):Display()
        wait(3)
        require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Welcome to Nara Hub<Color=/>"):Display()
        wait(4)
...
local SelectWeaponFarm = M:AddDropdown("SelectWeaponFarm", {
	Title = "Select Weapon",
...
local FastAttackFarm = M:AddDropdown("FastAttackFarm", {
...
local FastAttackFarm = M:AddToggle("FastAttackFarm", {Title = "Fast Attack", Default = true })
...
local AutoClick = M:AddToggle("AutoClic", {Title = "Auto Click", Default = false })
...
spawn(function()
   ...
   local FarmLevel = M:AddToggle("FarmLeve", {Title = "Auto Farm Level", Default = false })
